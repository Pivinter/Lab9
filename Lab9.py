...
def build_tree(num_nodes):
    ...
    for _ in range(num_nodes):
        root = insert_node(root, random.randint(1, 100))
    return root
...
print("1. Створити бінарне дерево")
print("2. Показати бінарне дерево")
...
while True:
    ...
    if choice == 1:
        ...
        root = build_tree(num_nodes)
        print("Бінарне дерево створено.")
    elif choice == 2:
